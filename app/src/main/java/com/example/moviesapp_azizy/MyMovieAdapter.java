...
public class MyMovieAdapter extends
    ...
    Context context;
    public MyMovieAdapter(MyMovieData[] myMovieData,MainActivity
            activity) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup
        ...
        View view =
                layoutInflater.inflate(R.layout.activity_movie_item_list,parent,false);
                                                   ...
                                                   View.OnClickListener() {
                                                       ...
                                                       public void onClick(View v) {
                                                           Toast.makeText(context,
                                                                   myMovieDataList.getMovieName(), Toast.LENGTH_SHORT).show();
                                                       }
                                                   });
    }
    @Override
